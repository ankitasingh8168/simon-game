// game_rule wale id ko select karne ke liye target kiya gaya hai 
// isme ek rule_container class hai jispar click karne se rule_container show aur hide hoga 
$("#game_rule").click(function(){
  $(".rule_container").toggleClass("vihide");
})

// close par click karne se rule container hide hoga 
